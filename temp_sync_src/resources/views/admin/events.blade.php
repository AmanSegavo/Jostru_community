...
<div class="animate-fade-in">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Atur kegiatan komunitas Jostru.</p>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="text-center py-5 text-muted">Belum ada event yang dijadwalkan.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <form action="{{ route('admin.events.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="location" class="form-control" placeholder="Contoh: Balai Desa / Online" style="border-radius:12px;">
                    </div>
                    <div class="mb-3">
                ...
                <div class="modal-footer border-0">
                    ...
                    <button type="submit" class="btn btn-primary" style="border-radius:12px;background:#22c55e;border:none;">Simpan Event</button>
                </div>
            </form>
        </div>
    </div>
