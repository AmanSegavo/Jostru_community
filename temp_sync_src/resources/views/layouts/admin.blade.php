    ...
    <div class="admin-wrapper">
        ...
        <aside class="admin-sidebar glass">
            ...
            <nav class="d-flex flex-column w-100">
                ...
                <a href="{{ route('admin.waste_deposits') }}" class="nav-item-admin {{ request()->routeIs('admin.waste_deposits') ? 'active' : '' }}">Setoran Limbah</a>
                ...
                <a href="{{ route('admin.messages') }}" class="nav-item-admin {{ request()->routeIs('admin.messages') ? 'active' : '' }}">Pesan Masuk</a>
