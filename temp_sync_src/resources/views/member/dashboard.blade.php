...
<div class="container mt-4 animate-fade-in">
    ...
    <div class="card p-0 glass mb-4 overflow-hidden border-0 shadow-lg" style="border-radius: 24px;">
        <div style="background: linear-gradient(135deg, var(--primary), var(--secondary)); padding: 3rem 2rem; position: relative;">
        ...
        <div style="padding: 1.5rem 2rem; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('member.card.editor') }}" class="btn btn-primary" style="border-radius: 12px; font-weight: 700;">🪪 Download Kartu</a>
            </div>
        </div>
    </div>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem; margin-bottom: 2rem;">
        ...
        <div class="card p-4 glass card-eco" style="border-radius: 20px; border-left: 4px solid #22c55e;">
            ...
            <a href="{{ route('member.chat.list') }}" class="btn btn-primary w-full mt-3" style="border-radius: 12px;">Buka Obrolan</a>
        </div>
    </div>
    ...
    <div class="card p-4 glass" style="border-radius: 20px; background: rgba(var(--primary-rgb), 0.03);">
        <div class="row align-items-center">
            <div class="col-md-2 text-center">
                <div style="width: 80px; height: 80px; background: var(--primary); border-radius: 20px; display: flex; align-items: center; justify-content: center; margin: 0 auto; box-shadow: var(--shadow-sm);">
...
<style>
    ...
    .card-eco:hover {
        ...
        box-shadow: 0 15px 30px rgba(var(--primary-h), var(--primary-s), var(--primary-l), 0.15);
