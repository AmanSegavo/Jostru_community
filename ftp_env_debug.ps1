# Re-upload .env with DEBUG=true and Correct Redirect URL
...
$tempFile = "$env:TEMP\jostru_env_debug.txt"
...
Write-Host "`n=== Upload .env (DEBUG=TRUE) ===" -ForegroundColor Yellow
try {
    Upload-File $tempFile "/htdocs/.env"
    Write-Host "`n.env berhasil diupload!" -ForegroundColor Green
} catch {
