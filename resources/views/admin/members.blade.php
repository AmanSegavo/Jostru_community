...
<dialog id="editModal">
    ...
    <form id="editForm" method="POST">
        ...
        <div class="modal-body">
            ...
            <div style="background:rgba(var(--primary-rgb,99,102,241),0.05); border:1px solid rgba(var(--primary-rgb,99,102,241),0.2); border-radius:12px; padding:15px; margin-bottom:1rem;">
                <h6 style="font-weight:700; margin-bottom:12px; color:var(--primary);">Hak Akses & Perizinan (Role Management)</h6>
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem;">
                    <div class="form-group"><label>Role / Peran</label>
                        <select name="role" id="e_role" class="form-control" required style="border: 2px solid var(--primary); font-weight:600;">
                            <option value="member">Member Biasa</option>
                            <option value="admin">Administrator</option>
                        </select>
                    </div>
                    <div class="form-group"><label>Akses Fitur Chat & Call</label>
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem;">
                    <div class="form-group"><label>Akses Posting Feed</label>
                        <select name="can_post" id="e_can_post" class="form-control" required>
                            <option value="1">Diizinkan</option>
                            <option value="0">Diblokir (Muted)</option>
                        </select>
                    </div>
                    <div class="form-group"><label>Akses Komentar</label>
                        <select name="can_comment" id="e_can_comment" class="form-control" required>
                            <option value="1">Diizinkan</option>
                            <option value="0">Diblokir (Muted)</option>
                        </select>
                    </div>
...
function openEditModal(member) {
    ...
    document.getElementById('e_can_comment').value = (member.can_comment ?? 1) ? "1" : "0";
